...
object XiaomiData {
        private val xiaomiNames = arrayOf("9T",
            "F2 Pro",
            "F3",
            "M3",
            "Mi 10T",
        ...
        private val xiaomiDetails = arrayOf("Redmi 9T menjadi hp Xiaomi yang paling terbaru rilis di 2021. Berada di lini hp Redmi 9 series, hp ini menawarkan spesifikasi yang lebih meningkat dari generasi sebelumnya.\n" +
                "\n" +
            ...
            "Poco F2 Pro menawarkan performa terbaik dengan pembekalan prosesor Snapdragon 865 serta di dukung memori UFS 3.1 dan LPDDR5 berkapasitas 8 GB.\n" +
                    "\n" +
            ...
            "Poco F3 hadir dengan layar AMOLED seluas 6,67 inci dan sudah dilapisi pelindung Corning Gorilla Glass 5. Tidak hanya itu, layar Poco F3 juga mendukung refresh rate 120Hz dan tampilan HDR10+.\n" +
                    "\n" +
            ...
            "Hp Xiaomi terbaru 2021 ini hadir dengan spesifikasi tinggi namun dibanderol harga yang terjangkau. Spesifikasi Poco M3 diotaki prosesor Snapdragon 662 dengan sokongan RAM 4 GB dan 6 GB. Sangat mumpuni untuk aktivitas sehari-hari hingga gaming.\n" +
                    "\n" +
            ...
            "Mi 10T memiliki layar IPS dengan bentang seluas 6.67 inci resolusi FullHD+. Layar ini juga sudah mendukung refresh rate 144 Hz yang memiliki keunggulan pada gerakan layar yang lebih smooth. \n" +
                    "\n" +
            ...
            "Salah satu fitur unggulan Redmi Note 10 sudah dibekali dengan layar berjenis Super AMOLED berukuran 6.43 inci beresolusi 1080 x 2400 piksel. Layar ini pun sudah dilapisi pelindung Corning Gorilla Glass 3.\n" +
                    "\n" +
            ...
            "Poco X3 Pro mengusung empat kamera belakang yang menawarkan konfigurasi kamera wide 48 MP, kamera ultrawide 8 MP, kamera macro 2 MP dan kamera depth 2 MP. Sedangkan kamera depannya sudah memiliki resolusi 20 MP.\n" +
                    "\n" +
        ...
        private val xiaomiImages = intArrayOf(R.drawable.xiaomi_9t,
            R.drawable.f2_pro,
            R.drawable.f3,
            R.drawable.m3,
            R.drawable.mi_10t,
            R.drawable.note_10,
            R.drawable.note_10_pro,
            R.drawable.note_7,
            R.drawable.note_8,
            R.drawable.x3_pro)

        val listData: ArrayList<Xiaomi>
            get() {
                val list = arrayListOf<Xiaomi>()
                for (position in xiaomiNames.indices) {
                    val xiaomi = Xiaomi()
                    val bufferCover = xiaomiNames[position].split("-")
                    xiaomi.name = xiaomiNames[position]
                    xiaomi.detail = xiaomiDetails[position]
                    xiaomi.photo = xiaomiImages[position]
                    list.add(xiaomi)
                }
                return list
            }
    fun parseTextFromFile(fname: String): String {
